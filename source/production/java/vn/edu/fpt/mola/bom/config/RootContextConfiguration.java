        ...
        implements AsyncConfigurer, SchedulingConfigurer
{
    ...
    private static final Logger schedulingLogger = LogManager
    ...
    public ThreadPoolTaskScheduler taskScheduler()
    {
        ...
        scheduler.setErrorHandler(t -> schedulingLogger
                .error("Unknown error occurred while executing task.", t));
